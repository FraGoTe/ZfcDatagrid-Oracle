<?php
namespace Panel\DataSource;

use ZfcDatagrid\Column;
use ZfcDatagrid\DataSource\AbstractDataSource;
use Panel\DataSource\Pagination\Adapter\OciSelect as PaginatorAdapter;
use Zend\Db\Sql;
use Zend\Db\Sql\Expression;

class OracleSelect extends AbstractDataSource
{
    /**
     *
     * @var Sql\Select
    ...
    public function execute()
    {
         ...
         */
        $filterColumn = new \ZfcDatagrid\DataSource\ZendSelect\Filter($this->getAdapter(), $select);
